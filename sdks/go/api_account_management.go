...
func (r ApiApiAccountBalanceGetRequest) Execute() (*http.Response, error) {
...
func (a *AccountManagementAPIService) ApiAccountBalanceGetExecute(r ApiApiAccountBalanceGetRequest) (*http.Response, error) {
	var (
