...
func (r ApiApiV1ExtendVideoPostRequest) ContentType(contentType string) ApiApiV1ExtendVideoPostRequest {
...
func (r ApiApiV1ExtendVideoPostRequest) Execute() (*http.Response, error) {
...
func (a *VideoAPIService) ApiV1ExtendVideoPostExecute(r ApiApiV1ExtendVideoPostRequest) (*http.Response, error) {
	var (
...
func (r ApiApiV1VideoDiffusionPostRequest) ContentType(contentType string) ApiApiV1VideoDiffusionPostRequest {
	r.contentType = &contentType
	return r
}
...
func (r ApiApiV1VideoDiffusionPostRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *VideoAPIService) ApiV1VideoDiffusionPostExecute(r ApiApiV1VideoDiffusionPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiApiV1VideoUpscalePostRequest) ContentType(contentType string) ApiApiV1VideoUpscalePostRequest {
	r.contentType = &contentType
	return r
}
...
func (r ApiApiV1VideoUpscalePostRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *VideoAPIService) ApiV1VideoUpscalePostExecute(r ApiApiV1VideoUpscalePostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
