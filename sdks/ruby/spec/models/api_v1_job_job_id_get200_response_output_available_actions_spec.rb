...
# Unit tests for OpenapiClient::ApiV1JobJobIdGet200ResponseOutputAvailableActions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiV1JobJobIdGet200ResponseOutputAvailableActions do
  #let(:instance) { OpenapiClient::ApiV1JobJobIdGet200ResponseOutputAvailableActions.new }

  describe 'test an instance of ApiV1JobJobIdGet200ResponseOutputAvailableActions' do
    it 'should create an instance of ApiV1JobJobIdGet200ResponseOutputAvailableActions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ApiV1JobJobIdGet200ResponseOutputAvailableActions)
    end
  end
  ...
  describe 'test attribute "outpaint"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "remix"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "reroll"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
