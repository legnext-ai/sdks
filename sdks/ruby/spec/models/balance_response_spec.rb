...
# Unit tests for OpenapiClient::BalanceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BalanceResponse do
  #let(:instance) { OpenapiClient::BalanceResponse.new }

  describe 'test an instance of BalanceResponse' do
    it 'should create an instance of BalanceResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BalanceResponse)
    end
  end
