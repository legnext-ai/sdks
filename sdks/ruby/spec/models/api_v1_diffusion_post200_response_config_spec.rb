...
# Unit tests for OpenapiClient::ApiV1DiffusionPost200ResponseConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiV1DiffusionPost200ResponseConfig do
  #let(:instance) { OpenapiClient::ApiV1DiffusionPost200ResponseConfig.new }

  describe 'test an instance of ApiV1DiffusionPost200ResponseConfig' do
    it 'should create an instance of ApiV1DiffusionPost200ResponseConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ApiV1DiffusionPost200ResponseConfig)
    end
  end

  describe 'test attribute "service_mode"' do
    it 'should work' do
