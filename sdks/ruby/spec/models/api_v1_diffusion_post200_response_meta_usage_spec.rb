...
# Unit tests for OpenapiClient::ApiV1DiffusionPost200ResponseMetaUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiV1DiffusionPost200ResponseMetaUsage do
  #let(:instance) { OpenapiClient::ApiV1DiffusionPost200ResponseMetaUsage.new }

  describe 'test an instance of ApiV1DiffusionPost200ResponseMetaUsage' do
    it 'should create an instance of ApiV1DiffusionPost200ResponseMetaUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ApiV1DiffusionPost200ResponseMetaUsage)
    end
  end
