...
# Unit tests for OpenapiClient::ApiV1JobJobIdGet200ResponseOutput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiV1JobJobIdGet200ResponseOutput do
  #let(:instance) { OpenapiClient::ApiV1JobJobIdGet200ResponseOutput.new }

  describe 'test an instance of ApiV1JobJobIdGet200ResponseOutput' do
    it 'should create an instance of ApiV1JobJobIdGet200ResponseOutput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ApiV1JobJobIdGet200ResponseOutput)
    end
  end
