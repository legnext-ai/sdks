...
# Unit tests for OpenapiClient::ApiV1DiffusionPost200ResponseConfigWebhookConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiV1DiffusionPost200ResponseConfigWebhookConfig do
  #let(:instance) { OpenapiClient::ApiV1DiffusionPost200ResponseConfigWebhookConfig.new }

  describe 'test an instance of ApiV1DiffusionPost200ResponseConfigWebhookConfig' do
    it 'should create an instance of ApiV1DiffusionPost200ResponseConfigWebhookConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ApiV1DiffusionPost200ResponseConfigWebhookConfig)
    end
  end
