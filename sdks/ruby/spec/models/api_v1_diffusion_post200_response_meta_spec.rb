...
# Unit tests for OpenapiClient::ApiV1DiffusionPost200ResponseMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiV1DiffusionPost200ResponseMeta do
  #let(:instance) { OpenapiClient::ApiV1DiffusionPost200ResponseMeta.new }

  describe 'test an instance of ApiV1DiffusionPost200ResponseMeta' do
    it 'should create an instance of ApiV1DiffusionPost200ResponseMeta' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ApiV1DiffusionPost200ResponseMeta)
    end
  end
