...
> <TaskResponse> api_v1_blend_post(opts)
...
begin
  # Blend
  result = api_instance.api_v1_blend_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_blend_post: #{e}"
end
```

#### Using the api_v1_blend_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_blend_post_with_http_info(opts)

```ruby
begin
  # Blend
  data, status_code, headers = api_instance.api_v1_blend_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_blend_post_with_http_info: #{e}"
end
```
...
> <TaskResponse> api_v1_describe_post(opts)
...
begin
  # Describe
  result = api_instance.api_v1_describe_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_describe_post: #{e}"
end
```

#### Using the api_v1_describe_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_describe_post_with_http_info(opts)

```ruby
begin
  # Describe
  data, status_code, headers = api_instance.api_v1_describe_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_describe_post_with_http_info: #{e}"
end
```
...
> <ApiV1DiffusionPost200Response> api_v1_diffusion_post(opts)
...
begin
  # Diffusion
  result = api_instance.api_v1_diffusion_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_diffusion_post: #{e}"
end
```

#### Using the api_v1_diffusion_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ApiV1DiffusionPost200Response>, Integer, Hash)> api_v1_diffusion_post_with_http_info(opts)

```ruby
begin
  # Diffusion
  data, status_code, headers = api_instance.api_v1_diffusion_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ApiV1DiffusionPost200Response>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_diffusion_post_with_http_info: #{e}"
end
```
...
> <ApiV1EditPost200Response> api_v1_edit_post(opts)
...
begin
  # Edit
  result = api_instance.api_v1_edit_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_edit_post: #{e}"
end
```

#### Using the api_v1_edit_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ApiV1EditPost200Response>, Integer, Hash)> api_v1_edit_post_with_http_info(opts)

```ruby
begin
  # Edit
  data, status_code, headers = api_instance.api_v1_edit_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ApiV1EditPost200Response>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_edit_post_with_http_info: #{e}"
end
```
...
> <TaskResponse> api_v1_inpaint_post(opts)
...
begin
  # Inpaint
  result = api_instance.api_v1_inpaint_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_inpaint_post: #{e}"
end
```

#### Using the api_v1_inpaint_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_inpaint_post_with_http_info(opts)

```ruby
begin
  # Inpaint
  data, status_code, headers = api_instance.api_v1_inpaint_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_inpaint_post_with_http_info: #{e}"
end
```
...
> <TaskResponse> api_v1_outpaint_post(opts)
...
begin
  # Outpaint
  result = api_instance.api_v1_outpaint_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_outpaint_post: #{e}"
end
```

#### Using the api_v1_outpaint_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_outpaint_post_with_http_info(opts)

```ruby
begin
  # Outpaint
  data, status_code, headers = api_instance.api_v1_outpaint_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_outpaint_post_with_http_info: #{e}"
end
```
...
> <ApiV1PanPost200Response> api_v1_pan_post(opts)
...
begin
  # Pan
  result = api_instance.api_v1_pan_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_pan_post: #{e}"
end
```

#### Using the api_v1_pan_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ApiV1PanPost200Response>, Integer, Hash)> api_v1_pan_post_with_http_info(opts)

```ruby
begin
  # Pan
  data, status_code, headers = api_instance.api_v1_pan_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ApiV1PanPost200Response>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_pan_post_with_http_info: #{e}"
end
```
...
> <TaskResponse> api_v1_remix_post(opts)
...
begin
  # Remix
  result = api_instance.api_v1_remix_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_remix_post: #{e}"
end
```

#### Using the api_v1_remix_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_remix_post_with_http_info(opts)

```ruby
begin
  # Remix
  data, status_code, headers = api_instance.api_v1_remix_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_remix_post_with_http_info: #{e}"
end
```
...
> <TaskResponse> api_v1_reroll_post(opts)
...
begin
  # Reroll
  result = api_instance.api_v1_reroll_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_reroll_post: #{e}"
end
```

#### Using the api_v1_reroll_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_reroll_post_with_http_info(opts)

```ruby
begin
  # Reroll
  data, status_code, headers = api_instance.api_v1_reroll_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_reroll_post_with_http_info: #{e}"
end
```
...
> <TaskResponse> api_v1_shorten_post(opts)
...
begin
  # Shorten
  result = api_instance.api_v1_shorten_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_shorten_post: #{e}"
end
```

#### Using the api_v1_shorten_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_shorten_post_with_http_info(opts)

```ruby
begin
  # Shorten
  data, status_code, headers = api_instance.api_v1_shorten_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_shorten_post_with_http_info: #{e}"
end
```
...
> <TaskResponse> api_v1_upscale_post(opts)
...
begin
  # Upscale
  result = api_instance.api_v1_upscale_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_upscale_post: #{e}"
end
```

#### Using the api_v1_upscale_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_upscale_post_with_http_info(opts)

```ruby
begin
  # Upscale
  data, status_code, headers = api_instance.api_v1_upscale_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_upscale_post_with_http_info: #{e}"
end
```
...
> <TaskResponse> api_v1_variation_post(opts)
...
begin
  # Variation
  result = api_instance.api_v1_variation_post(opts)
  p result
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_variation_post: #{e}"
end
```

#### Using the api_v1_variation_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TaskResponse>, Integer, Hash)> api_v1_variation_post_with_http_info(opts)

```ruby
begin
  # Variation
  data, status_code, headers = api_instance.api_v1_variation_post_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TaskResponse>
rescue OpenapiClient::ApiError => e
  puts "Error when calling ImageApi->api_v1_variation_post_with_http_info: #{e}"
end
```
