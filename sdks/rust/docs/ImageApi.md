...
> models::TaskResponse api_v1_blend_post(x_api_key, body)
Blend
...
> models::TaskResponse api_v1_describe_post(x_api_key, body)
Describe
...
> models::ApiV1DiffusionPost200Response api_v1_diffusion_post(x_api_key, body)
Diffusion
...
[**models::ApiV1DiffusionPost200Response**](_api_v1_diffusion_post_200_response.md)
...
> models::ApiV1EditPost200Response api_v1_edit_post(x_api_key, body)
Edit
...
[**models::ApiV1EditPost200Response**](_api_v1_edit_post_200_response.md)
...
> models::TaskResponse api_v1_inpaint_post(x_api_key, body)
Inpaint
...
> models::TaskResponse api_v1_outpaint_post(x_api_key, body)
Outpaint
...
> models::ApiV1PanPost200Response api_v1_pan_post(x_api_key, body)
Pan
...
[**models::ApiV1PanPost200Response**](_api_v1_pan_post_200_response.md)
...
> models::TaskResponse api_v1_remix_post(x_api_key, body)
Remix
...
> models::TaskResponse api_v1_reroll_post(x_api_key, body)
Reroll
...
> models::TaskResponse api_v1_shorten_post(x_api_key, body)
Shorten
...
> models::TaskResponse api_v1_upscale_post(x_api_key, body)
Upscale
...
> models::TaskResponse api_v1_variation_post(x_api_key, body)
Variation
