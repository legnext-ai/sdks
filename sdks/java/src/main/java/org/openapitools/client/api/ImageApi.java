...
import org.openapitools.client.model.ApiV1DiffusionPost200Response;
import org.openapitools.client.model.ApiV1EditPost200Response;
import org.openapitools.client.model.ApiV1PanPost200Response;
...
public class ImageApi {
     ...
     */
    public okhttp3.Call apiV1BlendPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable String body, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/v1/blend";
    ...
    private okhttp3.Call apiV1BlendPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable String body, final ApiCallback _callback) throws ApiException {
        return apiV1BlendPostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1BlendPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable String body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1BlendPostWithHttpInfo(xApiKey, body);
     ...
     */
    public ApiResponse<TaskResponse> apiV1BlendPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable String body) throws ApiException {
        okhttp3.Call localVarCall = apiV1BlendPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Blend (asynchronously)
     * ## Combine Multiple Images into Unified Creation  Seamlessly blend 2-5 images together to create a single unique image that combines elements, styles, and concepts from all source images.  ### How it Works  Upload 2-5 image URLs and specify an aspect ratio. The API analyzes all images and creates a cohesive blend that merges their visual elements, colors, styles, and concepts.  ### Required Parameters  - &#x60;imgUrls&#x60; - Array of 2-5 image URLs to blend      - &#x60;aspect_ratio&#x60; - Output aspect ratio: \&quot;2:3\&quot; (portrait), \&quot;1:1\&quot; (square), or \&quot;3:2\&quot; (landscape)       ### Authentication  Requires a valid API key passed in the &#x60;x-api-key&#x60; header.  ### Response  Returns a task object. The blended images (4 variations) will be sent to your callback URL when complete (typically 60-90 seconds).  ### Use Cases  - Combine style references for unique visual concepts      - Merge product photos with artistic styles      - Create hybrid concepts from multiple references      - Blend textures and patterns for design work      - Mix character designs or architectural styles       ### Tips  - Works best with 2-3 images; more images create more abstract results      - All source images should be publicly accessible URLs      - The blend is conceptual, not a simple overlay      - Consider the aspect ratio based on your intended use      - Experiment with different image composition, color palettes, or subject matter for varied results.
     * @param xApiKey  (optional)
     * @param body  (optional)
     ...
     */
    public okhttp3.Call apiV1BlendPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable String body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1BlendPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1DescribePost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1DescribePostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/describe";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1DescribePostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1DescribePostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1DescribePost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1DescribePostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> apiV1DescribePostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1DescribePostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call apiV1DescribePostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1DescribePostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1DiffusionPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1DiffusionPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/diffusion";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1DiffusionPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1DiffusionPostCall(xApiKey, body, _callback);
     ...
     */
    public ApiV1DiffusionPost200Response apiV1DiffusionPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<ApiV1DiffusionPost200Response> localVarResp = apiV1DiffusionPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @return ApiResponse&lt;ApiV1DiffusionPost200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<ApiV1DiffusionPost200Response> apiV1DiffusionPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1DiffusionPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<ApiV1DiffusionPost200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Diffusion (asynchronously)
     * ## Generate Image from Text Prompt (Diffusion)  Creates AI-generated images from text descriptions using Midjourney&#39;s diffusion model. This endpoint processes your prompt asynchronously and delivers the generated image to your specified callback URL.  ### How It Works  Submit a text prompt describing the image you want to create. The API processes your request using Midjourney&#39;s AI model and sends the generated image result to your callback URL when complete. Processing typically takes 30-90 seconds depending on complexity and queue length.  ### Required Parameters  - **&#x60;text&#x60;** (string, required) - Your image description prompt          - Example: &#x60;\&quot;A beautiful sunset over the snow mountains\&quot;&#x60;              - Supports Midjourney parameters like &#x60;--v 7&#x60; (model version), &#x60;--draft&#x60; (draft mode), &#x60;--ar 16:9&#x60; (aspect ratio)              - Be specific and descriptive for best results          - **&#x60;callback&#x60;** (string, required) - HTTPS webhook URL to receive the result          - Must be publicly accessible and accept POST requests              - Example: &#x60;\&quot;https://your-domain.com/webhook/image-result\&quot;&#x60;              - The API will send the generated image data to this URL when processing completes           ### Authentication  Requires a valid API key in the &#x60;x-api-key&#x60; header. Store your API key securely in environment variables and never expose it in client-side code.  ### Response  Returns immediately with a task ID and status. The actual generated image will be delivered to your callback URL asynchronously once processing completes.  ### Common Use Cases  - Generate marketing visuals and social media content      - Create concept art and design mockups      - Produce unique illustrations for articles and presentations      - Prototype visual ideas before commissioning custom artwork      - Build AI-powered image generation features into your applications       ### Tips for Success  - **Be specific:** Detailed prompts produce better results (e.g., \&quot;photorealistic mountain landscape at golden hour\&quot; vs \&quot;mountains\&quot;)      - **Use Midjourney parameters:** Add &#x60;--v 7&#x60; for the latest model version, &#x60;--ar 16:9&#x60; for widescreen format      - **Test your callback:** Ensure your webhook endpoint is accessible and can handle POST requests before submitting jobs      - **Handle async responses:** Implement proper webhook handling to receive and process results      - **Monitor task status:** Use the \&quot;Get task response\&quot; endpoint if you need to check job status manually       ### Related Endpoints  - **Get task response** - Check the status of your generation task      - **Variation** - Create variations of a generated image      - **Upscale** - Enhance the resolution of generated images      - **Reroll** - Generate alternative versions with the same prompt
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiV1DiffusionPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<ApiV1DiffusionPost200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1DiffusionPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<ApiV1DiffusionPost200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1EditPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1EditPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/edit";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1EditPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1EditPostCall(xApiKey, body, _callback);
     ...
     */
    public ApiV1EditPost200Response apiV1EditPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<ApiV1EditPost200Response> localVarResp = apiV1EditPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @return ApiResponse&lt;ApiV1EditPost200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<ApiV1EditPost200Response> apiV1EditPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1EditPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<ApiV1EditPost200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call apiV1EditPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<ApiV1EditPost200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1EditPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<ApiV1EditPost200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1InpaintPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1InpaintPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/inpaint";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1InpaintPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1InpaintPostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1InpaintPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1InpaintPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> apiV1InpaintPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1InpaintPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Inpaint (asynchronously)
     * ## Selectively Modify Image Regions with Masks  Repaint or modify specific regions within an existing image using mask-based editing. Target precise areas for changes while preserving the rest of the image.  ### How it Works  Select an image and define regions to modify using either polygon coordinates or a mask image URL. Optionally provide a prompt to guide what should appear in those regions. The API regenerates only the masked areas.  ### Required Parameters  - &#x60;jobId&#x60; - UUID of the original image generation task      - &#x60;imageNo&#x60; - Image number to edit (0, 1, 2, or 3)      - &#x60;mask&#x60; - Regions to repaint (use either areas array or url):          - &#x60;areas&#x60; - Array of polygons with width, height, and points (XYXY coordinates)              - &#x60;url&#x60; - Black and white mask image URL (white areas will be repainted)          - &#x60;remixPrompt&#x60; - Optional prompt for the repaint area (1-8192 characters)       ### Authentication  Requires a valid API key passed in the &#x60;x-api-key&#x60; header.  ### Response  Returns a task object. The inpainted images (4 variations) will be sent to your callback URL when complete (typically 90-120 seconds).  ### Use Cases  - Remove unwanted objects from images      - Replace specific elements while keeping surroundings      - Modify facial expressions or poses      - Change colors or textures in targeted areas      - Fix specific issues without regenerating entire image       ### Tips  - Polygon points format: \\[x1,y1, x2,y2, x3,y3, x4,y4\\] in clockwise order      - Mask images: white &#x3D; repaint, black &#x3D; keep original      - Use remixPrompt to specify what should replace masked content      - Smaller masks give more precise control      - Can apply multiple polygon areas in a single request
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiV1InpaintPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1InpaintPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1OutpaintPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1OutpaintPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/outpaint";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1OutpaintPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1OutpaintPostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1OutpaintPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1OutpaintPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> apiV1OutpaintPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1OutpaintPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Outpaint (asynchronously)
     * ## Expand Images in All Directions  Extend an image uniformly in all directions using intelligent outpainting. Creates a larger canvas while maintaining the original image at the center.  ### How it Works  Select an image and specify scale factor. The API expands the canvas uniformly in all directions and generates new content that naturally continues the scene on all sides.  ### Required Parameters  - &#x60;jobId&#x60; - UUID of the original image generation task      - &#x60;imageNo&#x60; - Image number to expand (0, 1, 2, or 3)      - &#x60;scale&#x60; - Extension scale ratio (1.1 to 2.0, e.g., 1.5 &#x3D; 50% larger in all directions)      - &#x60;remixPrompt&#x60; - Optional prompt to guide the outpainted areas (1-8192 characters)       ### Authentication  Requires a valid API key passed in the &#x60;x-api-key&#x60; header.  ### Response  Returns a task object. The outpainted images (4 variations) will be sent to your callback URL when complete (typically 90-120 seconds).  ### Use Cases  - Add environmental context around subject-focused images      - Create wider scenes from cropped compositions      - Extend backgrounds for design flexibility      - Generate variations with different surrounding content      - Prepare images for different aspect ratios       ### Tips  - Scale range 1.1-2.0 (outpaint is more conservative than pan)      - Use remixPrompt to describe desired surrounding content      - Great for adding context without losing the original subject      - Original image remains intact at center      - Compare with pan for directional control vs. uniform expansion
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiV1OutpaintPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1OutpaintPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1PanPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1PanPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/pan";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1PanPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1PanPostCall(xApiKey, body, _callback);
     ...
     */
    public ApiV1PanPost200Response apiV1PanPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<ApiV1PanPost200Response> localVarResp = apiV1PanPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @return ApiResponse&lt;ApiV1PanPost200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<ApiV1PanPost200Response> apiV1PanPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1PanPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<ApiV1PanPost200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call apiV1PanPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<ApiV1PanPost200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1PanPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<ApiV1PanPost200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1RemixPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1RemixPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/remix";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1RemixPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1RemixPostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1RemixPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1RemixPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> apiV1RemixPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1RemixPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Remix (asynchronously)
     * ## Transform Images with New Prompts  Apply a new text prompt to an existing image, transforming it while maintaining aspects of the original composition. Controllable intensity for subtle or dramatic changes.  ### How it Works  Select an image and provide a new prompt. The API applies the new description to the existing image, creating variations that blend the original structure with the new concept. Intensity mode controls how strongly the new prompt is applied.  ### Required Parameters  - &#x60;jobId&#x60; - UUID of the original image generation task      - &#x60;imageNo&#x60; - Image number to remix (0, 1, 2, or 3)      - &#x60;remixPrompt&#x60; - New prompt to apply to the image (1-8192 characters)      - &#x60;mode&#x60; - Remix intensity: 0&#x3D;Strong (significant transformation), 1&#x3D;Subtle (light transformation)       ### Authentication  Requires a valid API key passed in the &#x60;x-api-key&#x60; header.  ### Response  Returns a task object. The remixed images (4 variations) will be sent to your callback URL when complete (typically 90-120 seconds).  ### Use Cases  - Change the style or mood of an existing image      - Apply different artistic directions to the same composition      - Modify time of day, weather, or season in scenes      - Transform realistic images to artistic styles (or vice versa)      - Iterate on concepts by applying different prompts       ### Tips  - Mode 0 (Strong) makes dramatic changes while keeping some structure      - Mode 1 (Subtle) makes gentle modifications, preserving more of the original      - Remix prompt completely replaces the original prompt      - Great for style transfer and conceptual variations      - Experiment with both modes to find the right balance
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiV1RemixPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1RemixPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1RerollPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1RerollPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/reroll";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1RerollPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1RerollPostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1RerollPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1RerollPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> apiV1RerollPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1RerollPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Reroll (asynchronously)
     * ## Re-execute Task with Same Parameters  Regenerate a new set of images using the exact same parameters as a previous task. This is equivalent to running the original request again with identical settings.  ### How it Works  Provide a previous task&#39;s job ID and the API will execute the same generation with the same prompt and parameters, producing 4 completely new variations.  ### Required Parameters  - &#x60;jobId&#x60; - UUID of the task to reroll       ### Authentication  Requires a valid API key passed in the &#x60;x-api-key&#x60; header.  ### Response  Returns a new task object with different &#x60;job_id&#x60;. The rerolled images (4 new variations) will be sent to your callback URL when complete (typically 60-90 seconds).  ### Use Cases  - Try the same prompt again if initial results didn&#39;t meet expectations      - Generate additional variations without retyping prompts      - Explore different random seeds for the same concept      - Create more options from successful prompts       ### Tips  - Reroll uses the exact same parameters as the original task      - Results will be completely different due to different random seeds      - Consider using variation endpoint instead if you want to build on a specific result      - You can reroll any completed task, even from previous sessions
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiV1RerollPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1RerollPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1ShortenPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1ShortenPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/shorten";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1ShortenPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1ShortenPostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1ShortenPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1ShortenPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> apiV1ShortenPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1ShortenPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Shorten (asynchronously)
     * ## Simplify Prompts to Essential Elements  Analyze a long or complex prompt and reduce it to its most essential and impactful elements, maintaining effectiveness while improving clarity.  ### How it Works  Submit a lengthy prompt and the API analyzes it using AI, identifying the most important elements and removing redundancy. Returns multiple shortened variations.  ### Required Parameters  - &#x60;prompt&#x60; - The text prompt to simplify (1-8192 characters)       ### Authentication  Requires a valid API key passed in the &#x60;x-api-key&#x60; header.  ### Response  Returns a task object. The shortened prompt variations will be sent to your callback URL when complete (typically 20-40 seconds).  ### Use Cases  - Optimize overly verbose prompts for better results      - Learn which prompt elements are most impactful      - Reduce token usage in prompt-based workflows      - Clean up accumulated prompt modifications      - Simplify complex prompts for better model understanding       ### Tips  - Particularly useful for prompts over 100 words      - The AI preserves key descriptive elements while removing filler      - Multiple variations help you choose the best simplified version      - Test both original and shortened prompts to compare results      - Great for learning concise prompt writing techniques
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiV1ShortenPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1ShortenPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1UpscalePost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1UpscalePostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/upscale";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1UpscalePostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1UpscalePostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1UpscalePost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1UpscalePostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> apiV1UpscalePostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1UpscalePostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call apiV1UpscalePostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1UpscalePostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for apiV1VariationPost
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call apiV1VariationPostCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/v1/variation";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiV1VariationPostValidateBeforeCall(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback _callback) throws ApiException {
        return apiV1VariationPostCall(xApiKey, body, _callback);
     ...
     */
    public TaskResponse apiV1VariationPost(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        ApiResponse<TaskResponse> localVarResp = apiV1VariationPostWithHttpInfo(xApiKey, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TaskResponse> apiV1VariationPostWithHttpInfo(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body) throws ApiException {
        okhttp3.Call localVarCall = apiV1VariationPostValidateBeforeCall(xApiKey, body, null);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Variation (asynchronously)
     * ## Create Controlled Variations of Existing Images  Generate new variations of a specific image from a previous generation task with controllable transformation intensity. Perfect for exploring different interpretations while maintaining the core composition.  ### How it Works  Select one of the 4 generated images from a diffusion task and create variations with either subtle or strong intensity. The API generates 4 new variations based on your selected image and intensity setting.  ### Required Parameters  - &#x60;jobId&#x60; - UUID of the original image generation task      - &#x60;imageNo&#x60; - Image number to vary (0, 1, 2, or 3)      - &#x60;type&#x60; - Variation intensity: 0&#x3D;Subtle (minor changes), 1&#x3D;Strong (major changes)      - &#x60;remixPrompt&#x60; - Optional additional prompt for guided variation (1-8192 characters)       ### Authentication  Requires a valid API key passed in the &#x60;x-api-key&#x60; header.  ### Response  Returns a new task object with &#x60;job_id&#x60;. The 4 variation images will be sent to your callback URL when processing completes (typically 60-90 seconds).  ### Use Cases  - Explore different interpretations of a successful generation      - Fine-tune specific aspects of an image      - Create multiple versions for A/B testing      - Generate variations for client review      - Remix images with additional prompt guidance       ### Tips  - Use type&#x3D;0 (subtle) for minor refinements, type&#x3D;1 (strong) for significant changes      - Add remixPrompt to guide the variation in a specific direction      - The original composition and structure are generally preserved      - Can chain variations: create variations of variations for iterative refinement
     * @param xApiKey  (optional)
     * @param body  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiV1VariationPostAsync(@javax.annotation.Nullable String xApiKey, @javax.annotation.Nullable Object body, final ApiCallback<TaskResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiV1VariationPostValidateBeforeCall(xApiKey, body, _callback);
        Type localVarReturnType = new TypeToken<TaskResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
