...
/**
 * ApiV1EditPost200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1EditPost200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_edit_post_200_response';
    ...
    */
     ...
     * Sets job_id
     *
     * @param string|null $job_id Unique identifier for the created edit job
     *
     * @return self
     */
     ...
     * Sets task_type
     *
     * @param string|null $task_type Type of task (e.g., edit)
     *
     * @return self
     */
