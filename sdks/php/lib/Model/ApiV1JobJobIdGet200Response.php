 ...
 */
class ApiV1JobJobIdGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_api_v1_job__job_id__get_200_response';
    ...
    */
     ...
     * Sets job_id
     *
     * @param string|null $job_id Unique identifier for the job
     *
     * @return self
     */
     ...
     * Sets task_type
     *
     * @param string|null $task_type Type of task (e.g., diffusion)
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Current status (pending, staged, processing, completed, failed)
     *
     * @return self
     */
     ...
     * Sets input
     *
     * @param object|null $input Input parameters for the task
     *
     * @return self
     */
