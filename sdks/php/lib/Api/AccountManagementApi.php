...
class AccountManagementApi
{
    ...
    /**
     * Operation apiAccountBalanceGet
     *
     * get account balance
     *
    ...
    /**
     * Operation apiAccountBalanceGetWithHttpInfo
     *
     * get account balance
     *
    ...
    /**
     * Operation apiAccountBalanceGetAsync
     *
     * get account balance
     *
     * @param  string|null $x_api_key (optional)
     ...
     */
    public function apiAccountBalanceGetAsync($x_api_key = null, string $contentType = self::contentTypes['apiAccountBalanceGet'][0])
    {
        return $this->apiAccountBalanceGetAsyncWithHttpInfo($x_api_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiAccountBalanceGetAsyncWithHttpInfo
     *
     * get account balance
     *
     * @param  string|null $x_api_key (optional)
    ...
    /**
     * Create request for operation 'apiAccountBalanceGet'
     *
     * @param  string|null $x_api_key (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiAccountBalanceGet'] to see the possible values for this operation
     *
     ...
     */
    public function apiAccountBalanceGetRequest($x_api_key = null, string $contentType = self::contentTypes['apiAccountBalanceGet'][0])
    {



        $resourcePath = '/api/account/balance';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
