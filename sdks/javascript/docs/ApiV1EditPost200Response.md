...
------------ | ------------- | ------------- | -------------
**job_id** | **string** | Unique identifier for the created edit job | [optional] [default to undefined]
**model** | **string** | AI model used (e.g., midjourney) | [optional] [default to undefined]
**task_type** | **string** | Type of task (e.g., edit) | [optional] [default to undefined]
...
```typescript
import { ApiV1EditPost200Response } from './api';

const instance: ApiV1EditPost200Response = {
    job_id,
    model,
    task_type,
    status,
