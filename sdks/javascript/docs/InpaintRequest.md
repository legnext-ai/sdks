...
**mask** | [**InpaintRequestMask**](InpaintRequestMask.md) |  | [default to undefined]
**remixPrompt** | **string** | Text prompt for the repaint area | [optional] [default to undefined]
**callback** | **string** | Callback URL for task completion notifications | [optional] [default to undefined]

## Example

```typescript
import { InpaintRequest } from '@legnext/midjourney-sdk';

const instance: InpaintRequest = {
    jobId,
    imageNo,
    mask,
    remixPrompt,
