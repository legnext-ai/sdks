...
------------ | ------------- | ------------- | -------------
**job_id** | **string** | Unique identifier for the created pan job | [optional] [default to undefined]
**model** | **string** | AI model used (e.g., midjourney) | [optional] [default to undefined]
**task_type** | **string** | Type of task (e.g., pan) | [optional] [default to undefined]
...
```typescript
import { ApiV1PanPost200Response } from './api';

const instance: ApiV1PanPost200Response = {
    job_id,
    model,
    task_type,
    status,
