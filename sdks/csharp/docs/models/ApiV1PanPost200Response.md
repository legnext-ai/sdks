# Org.OpenAPITools.Model.ApiV1PanPost200Response

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**JobId** | **string** | Unique identifier for the created pan job | [optional] 
**Model** | **string** | AI model used (e.g., midjourney) | [optional] 
**TaskType** | **string** | Type of task (e.g., pan) | [optional] 
