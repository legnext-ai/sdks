...
class ApiV1JobJobIdGet200ResponseOutput(BaseModel):
    """
    ...
    available_actions: Optional[ApiV1JobJobIdGet200ResponseOutputAvailableActions] = None
    __properties: ClassVar[List[str]] = ["image_url", "image_urls", "seed", "available_actions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.available_actions:
            _dict['available_actions'] = self.available_actions.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seed": obj.get("seed"),
            "available_actions": ApiV1JobJobIdGet200ResponseOutputAvailableActions.from_dict(obj["available_actions"]) if obj.get("available_actions") is not None else None
        })
        return _obj
