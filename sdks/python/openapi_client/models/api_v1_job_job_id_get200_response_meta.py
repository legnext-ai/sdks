...
class ApiV1JobJobIdGet200ResponseMeta(BaseModel):
    """
    ...
    usage: Optional[ApiV1DiffusionPost200ResponseMetaUsage] = None
    __properties: ClassVar[List[str]] = ["created_at", "started_at", "ended_at", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usage": ApiV1DiffusionPost200ResponseMetaUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
