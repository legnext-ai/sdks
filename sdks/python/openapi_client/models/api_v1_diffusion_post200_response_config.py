...
class ApiV1DiffusionPost200ResponseConfig(BaseModel):
    """
    ApiV1DiffusionPost200ResponseConfig
    """ # noqa: E501
    service_mode: Optional[StrictStr] = None
    webhook_config: Optional[ApiV1DiffusionPost200ResponseConfigWebhookConfig] = None
    __properties: ClassVar[List[str]] = ["service_mode", "webhook_config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "service_mode": obj.get("service_mode"),
            "webhook_config": ApiV1DiffusionPost200ResponseConfigWebhookConfig.from_dict(obj["webhook_config"]) if obj.get("webhook_config") is not None else None
        })
        return _obj
