...
class ApiV1EditPost200Response(BaseModel):
    """
    ApiV1EditPost200Response
    """ # noqa: E501
    job_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the created edit job")
    model: Optional[StrictStr] = Field(default=None, description="AI model used (e.g., midjourney)")
    task_type: Optional[StrictStr] = Field(default=None, description="Type of task (e.g., edit)")
