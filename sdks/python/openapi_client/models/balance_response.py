...
class BalanceResponse(BaseModel):
    ...
    BalanceResponse
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Response status code")
    message: Optional[StrictStr] = Field(default=None, description="Response message")
    data: Optional[BalanceResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": BalanceResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
