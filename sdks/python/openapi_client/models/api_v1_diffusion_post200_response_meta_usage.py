...
class ApiV1DiffusionPost200ResponseMetaUsage(BaseModel):
    """
    ApiV1DiffusionPost200ResponseMetaUsage
    """ # noqa: E501
    type: Optional[StrictStr] = None
    frozen: Optional[StrictInt] = None
    consume: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["type", "frozen", "consume"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1DiffusionPost200ResponseMetaUsage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1DiffusionPost200ResponseMetaUsage from a dict"""
        if obj is None:
            return None
