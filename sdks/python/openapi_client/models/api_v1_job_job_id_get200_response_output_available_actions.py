...
class ApiV1JobJobIdGet200ResponseOutputAvailableActions(BaseModel):
    """
    ApiV1JobJobIdGet200ResponseOutputAvailableActions
    """ # noqa: E501
    edit: Optional[List[StrictInt]] = None
    inpaint: Optional[List[StrictInt]] = None
    outpaint: Optional[List[StrictInt]] = None
    pan: Optional[List[StrictInt]] = None
    remix: Optional[List[StrictInt]] = None
    reroll: Optional[StrictBool] = None
    upscale: Optional[List[StrictInt]] = None
    variation: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["edit", "inpaint", "outpaint", "pan", "remix", "reroll", "upscale", "variation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "edit": obj.get("edit"),
            "inpaint": obj.get("inpaint"),
            "outpaint": obj.get("outpaint"),
            "pan": obj.get("pan"),
            "remix": obj.get("remix"),
            "reroll": obj.get("reroll"),
