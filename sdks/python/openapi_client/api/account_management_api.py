...
class AccountManagementApi:
    ...
    def api_account_balance_get(
        ...
        _param = self._api_account_balance_get_serialize(
            x_api_key=x_api_key,
    ...
    @validate_call
    def api_account_balance_get_with_http_info(
        self,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_account_balance_get_without_preload_content(
        self,
        x_api_key: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _api_account_balance_get_serialize(
        self,
        x_api_key,
        _request_auth,
        _content_type,
